...
object CharlesKOgden{
    ...
    val letterB = listOf(
        ...
        "basket", "bath", "be (are)", "beautiful", "because", "bed", "bee", "before",
        ...
        "bulb", "burn", "burst", "business", "but", "butter", "button", "by"
    )
    val letterC = listOf(
        ...
        "cook", "copper", "copy", "cord", "cork", "cotton", "cough", "country", "cover",
        "cow", "crack", "credit", "crime", "cruel", "crush", "cry", "cup", "current",
        "curtain", "curve", "cushion", "cut"
    )
    val letterD = listOf(
    ...
    val letterF = listOf(
        ...
        "friend", "from", "front", "fruit", "full", "future"
    )
    val letterG = listOf(
    ...
    val letterI = listOf(
        "ice", "idea", "if", "ill", "important", "impulse", "in", "increase",
    ...
    val letterL = listOf(
        "land", "language", "last", "late", "laugh", "law", "lead", "leaf", "learning",
        "leather", "left", "leg", "let", "letter", "level", "library", "lift", "light",
        "like", "limit", "line", "linen", "lip", "liquid", "list", "little", "less",
        "least", "living", "lock", "long", "look", "loose", "loss", "loud", "love", "low"
    )
    val letterM = listOf(
    ...
    val letterO = listOf(
        ...
        "open", "operation", "opinion", "opposite", "or", "orange", "order", "organization",
        "ornament", "other", "out", "oven", "over", "owner"
    )
    val letterP = listOf(
        "page", "pain", "paint", "paper", "parallel", "parcel", "part", "past", "paste",
        "payment", "peace", "pen", "pencil", "person", "physical", "picture", "pig",
        "pin", "pipe", "place", "plane", "plant", "plate", "play", "please", "pleasure",
        "plough", "plow", "pocket", "point", "poison", "polish", "political", "poor",
        "porter", "position", "possible", "pot", "potato", "powder", "power", "present",
        "price", "print", "prison", "private", "probable", "process", "produce", "profit",
    ...
    val letterS = listOf(
        ...
        "solid", "some", "son", "song", "sort", "sound", "south", "soup", "space", "spade",
        "special", "sponge", "spoon", "spring", "square", "stamp", "stage", "star", "start",
        "statement", "station", "steam", "stem", "steel", "step", "stick", "sticky", "still",
        "stitch", "stocking", "stomach", "stone", "stop", "store", "story", "strange", "street",
        "stretch", "stiff", "straight", "strong", "structure", "substance", "such", "sudden",
        "sugar", "suggestion", "summer", "sun", "support", "surprise", "sweet", "swim", "system"
    )
    val letterT = listOf(
        "table", "tail", "take", "talk", "tall", "taste", "tax", "teaching", "tendency",
        "test", "than", "that", "the", "then", "theory", "there", "thick", "thin", "thing",
        "this", "though", "thought", "thread", "throat", "through", "thumb", "thunder",
        "ticket", "tight", "till", "time", "tin", "tired", "to", "toe", "together", "tomorrow",
        "tongue", "tooth", "top", "touch", "town", "trade", "train", "transport", "tray",
        "tree", "trick", "trouble", "trousers", "true", "turn", "twist"
    )
    val letterU = listOf(
    ...
    val letterW = listOf(
        ...
        "wave", "wax", "way", "weather", "week", "weight", "well", "west", "wet", "wheel",
        "when", "where", "while", "whip", "whistle", "white", "who", "why", "wide", "will",
        "wind", "window", "wine", "wing", "winter", "wire", "wise", "with", "woman", "wood",
        "wool", "word", "work", "worm", "wound", "writing", "wrong"
    )
    val letterY = listOf(
